const Contest = ({ contest }) => {
  const { contestName, image, attendance, description } = contest;
  ...
  return (
    <>
      <div
        ...
        className="bg-no-repeat bg-cover bg-center lg:bg-left flex flex-col w-[90%] lg:w-full h-96 md:h-[400px] m-2 brightness-110 hover:brightness-90 mx-auto"
      >
